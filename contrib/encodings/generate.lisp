...
(defconstant +aliases+
  '((:us-ascii :ascii)
    ...
    (:iso-8859-1 :iso8859-1 :latin-1 :latin1 :cp819 :ibm819)
    ...
    (:iso-8859-6 :iso8859-6 :arabic :asmo-708 :ecma-114)
    (:iso-8859-7 :iso8859-7 :greek8 :greek :ecma-118)
    (:iso-8859-8 :iso8859-8 :hebrew)
    (:iso-8859-9 :iso8859-9 :latin-5 :latin5)
    (:iso-8859-10 :iso8859-10 :latin-6 :latin6)
