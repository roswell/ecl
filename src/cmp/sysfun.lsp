...
#+complex-float (def-inline cl:aref :unsafe ((array si:complex-single-float) fixnum fixnum) :csfloat "@0;(#0)->array.self.csf[#1*(#0)->array.dims[1]+#2]")
#+complex-float (def-inline cl:aref :unsafe ((array si:complex-double-float) fixnum fixnum) :cdfloat "@0;(#0)->array.self.cdf[#1*(#0)->array.dims[1]+#2]")
#+complex-float (def-inline cl:aref :unsafe ((array si:complex-long-float) fixnum fixnum) :clfloat "@0;(#0)->array.self.clf[#1*(#0)->array.dims[1]+#2]")
...
#+complex-float (def-inline cl:aref :unsafe ((array si:complex-single-float) fixnum) :csfloat "(#0)->array.self.csf[#1]")
#+complex-float (def-inline cl:aref :unsafe ((array si:complex-double-float) fixnum) :cdfloat "(#0)->array.self.cdf[#1]")
#+complex-float (def-inline cl:aref :unsafe ((array si:complex-long-float) fixnum) :clfloat "(#0)->array.self.clf[#1]")    
...
#+complex-float (def-inline cl:row-major-aref :unsafe ((array si:complex-single-float) fixnum) :csfloat "(#0)->array.self.csf[#1]")
#+complex-float (def-inline cl:row-major-aref :unsafe ((array si:complex-double-float) fixnum) :cdfloat "(#0)->array.self.cdf[#1]")
#+complex-float (def-inline cl:row-major-aref :unsafe ((array si:complex-long-float) fixnum) :clfloat "(#0)->array.self.clf[#1]")
...
(def-inline cl:array-rank :unsafe (array) :fixnum
 "@0;(((#0)->d.t == t_array)?(#0)->array.rank:1)")
(def-inline cl:array-rank :always (array) :fixnum
 "ecl_array_rank(#0)")

(def-inline cl:array-dimension :always (t t) fixnum
 "ecl_array_dimension(#0,ecl_to_size(#1))")
(def-inline cl:array-dimension :always (t fixnum) fixnum
...
#+complex-float (def-inline cl:1+ :always (si:complex-single-float) :csfloat "(_Complex float)(#0)+1")
#+complex-float (def-inline cl:1+ :always (si:complex-double-float) :cdfloat "(_Complex double)(#0)+1")
#+complex-float (def-inline cl:1+ :always (si:complex-long-float) :clfloat "(_Complex long double)(#0)+1")
...
(def-inline cl:floor :always (fixnum fixnum) :fixnum
...
(def-inline cl:mod :always (fixnum fixnum) :fixnum
...
(def-inline cl:< :always (fixnum-float fixnum-float) :bool "(#0)<(#1)")
(def-inline cl:< :always (fixnum-float fixnum-float fixnum-float) :bool
            "@012;((#0)<(#1) && (#1)<(#2))")
...
#+ieee-floating-point (def-inline cl:max :always (t t) t "@01;((ecl_float_nan_p(#1) || ecl_greatereq(#0,#1))?#0:#1)")
#-ieee-floating-point (def-inline cl:max :always (t t) t "@01;(ecl_greatereq(#0,#1)?#0:#1)")
(def-inline cl:max :always (fixnum fixnum) :fixnum "@01;(#0)>=(#1)?#0:#1")

#+ieee-floating-point (def-inline cl:min :always (t t) t "@01;((ecl_float_nan_p(#1) || ecl_lowereq(#0,#1))?#0:#1)")
#-ieee-floating-point (def-inline cl:min :always (t t) t "@01;(ecl_lowereq(#0,#1)?#0:#1)")
...
(def-inline cl:expt :always ((long-float 0.0 *) long-float) :long-double "powl((long double)#0,(long double)#1)")
(def-inline cl:expt :always ((double-float 0.0 *) double-float) :double "pow((double)#0,(double)#1)")
(def-inline cl:expt :always ((single-float 0.0 *) single-float) :float "powf((float)#0,(float)#1)")
#+complex-float (def-inline cl:expt :always (si:complex-single-float si:complex-single-float) :csfloat "cpowf(#0,#1)")
#+complex-float (def-inline cl:expt :always (si:complex-double-float si:complex-double-float) :cdfloat "cpow(#0,#1)")
#+complex-float (def-inline cl:expt :always (si:complex-long-float si:complex-long-float) :clfloat "cpowl(#0,#1)")
...
#+complex-float (def-inline cl:log :always (si:complex-single-float) :csfloat "clogf(#0)")
#+complex-float (def-inline cl:log :always (si:complex-double-float) :cdfloat "clog(#0)")
#+complex-float (def-inline cl:log :always (si:complex-long-float) :clfloat "clogl(#0)")

(def-inline cl:sqrt :always (number) number "ecl_sqrt(#0)")
(def-inline cl:sqrt :always ((long-float 0.0 *)) :long-double "sqrtl((long double)(#0))")
(def-inline cl:sqrt :always ((double-float 0.0 *)) :double "sqrt((double)(#0))")
(def-inline cl:sqrt :always ((single-float 0.0 *)) :float "sqrtf((float)(#0))")
#+complex-float (def-inline cl:sqrt :always (si:complex-single-float) :csfloat "csqrtf(#0)")
#+complex-float (def-inline cl:sqrt :always (si:complex-double-float) :cdfloat "csqrt(#0)")
#+complex-float (def-inline cl:sqrt :always (si:complex-long-float) :clfloat "csqrtl(#0)")
...
#+complex-float (def-inline cl:sin :always (si:complex-single-float) :csfloat "csinf(#0)")
#+complex-float (def-inline cl:sin :always (si:complex-double-float) :cdfloat "csin(#0)")
#+complex-float (def-inline cl:sin :always (si:complex-long-float) :clfloat "csinl(#0)")
...
#+complex-float (def-inline cl:cos :always (si:complex-single-float) :csfloat "ccosf(#0)")
#+complex-float (def-inline cl:cos :always (si:complex-double-float) :cdfloat "ccos(#0)")
#+complex-float (def-inline cl:cos :always (si:complex-long-float) :clfloat "ccosl(#0)")
...
#+complex-float (def-inline cl:tan :always (si:complex-single-float) :csfloat "ctanf(#0)")
#+complex-float (def-inline cl:tan :always (si:complex-double-float) :cdfloat "ctan(#0)")
#+complex-float (def-inline cl:tan :always (si:complex-long-float) :clfloat "ctanl(#0)")
...
#+complex-float (def-inline cl:sinh :always (si:complex-single-float) :csfloat "csinhf(#0)")
#+complex-float (def-inline cl:sinh :always (si:complex-double-float) :cdfloat "csinh(#0)")
#+complex-float (def-inline cl:sinh :always (si:complex-long-float) :clfloat "csinhl(#0)")
...
#+complex-float (def-inline cl:cosh :always (si:complex-single-float) :csfloat "ccoshf(#0)")
#+complex-float (def-inline cl:cosh :always (si:complex-double-float) :cdfloat "ccosh(#0)")
#+complex-float (def-inline cl:cosh :always (si:complex-long-float) :clfloat "ccoshl(#0)")
...
#+complex-float (def-inline cl:tanh :always (si:complex-single-float) :csfloat "ctanhf(#0)")
#+complex-float (def-inline cl:tanh :always (si:complex-double-float) :cdfloat "ctanh(#0)")
#+complex-float (def-inline cl:tanh :always (si:complex-long-float) :clfloat "ctanhl(#0)")
...
(def-inline cl:eql :always ((not (or complex bignum ratio float)) t) :bool
 "(#0)==(#1)")
(def-inline cl:eql :always (t (not (or complex bignum ratio float))) :bool
 "(#0)==(#1)")
...
(def-inline cl:aref :unsafe ((array bit) fixnum) :fixnum "ecl_aref_bv(#0,#1)")
#+unicode
(def-inline cl:aref :unsafe ((array character) fixnum) :wchar
 "(#0)->string.self[#1]")
(def-inline cl:aref :unsafe ((array base-char) fixnum) :unsigned-char
 "(#0)->base_string.self[#1]")
(def-inline cl:aref :unsafe ((array double-float) fixnum) :double
 "(#0)->array.self.df[#1]")
(def-inline cl:aref :unsafe ((array single-float) fixnum) :float
 "(#0)->array.self.sf[#1]")
(def-inline cl:aref :unsafe ((array fixnum) fixnum) :fixnum
 "(#0)->array.self.fix[#1]")
