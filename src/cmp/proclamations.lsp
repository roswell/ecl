...
#+formatter (proclamation si::format-princ (stream-designator t gen-bool gen-bool integer integer integer character) t)
#+formatter (proclamation si::format-prin1 (stream-designator t gen-bool gen-bool integer integer integer character) t)
#+formatter (proclamation si::format-print-named-character (character stream-designator) t)
#+formatter (proclamation si::format-print-integer (stream-designator t gen-bool gen-bool radix integer character character integer) t)
...
#+formatter (proclamation si::format-fixed (stream-designator t integer integer integer character character gen-bool) t)
#+formatter (proclamation si::format-exponential (stream-designator t integer integer integer integer character character character gen-bool) t)
#+formatter (proclamation si::format-general (stream-designator t integer integer integer integer character character character gen-bool) t)
