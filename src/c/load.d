               ...
               cl_object print, cl_object external_format)
{
  ...
  prefix = ecl_symbol_value_nonnull(the_env, @'si::*init-function-prefix*');
...
@(defun load (source
              &key (verbose ecl_symbol_value_nonnull(the_env, @'*load-verbose*'))
              (print ecl_symbol_value_nonnull(the_env, @'*load-print*'))
              (if_does_not_exist @':error')
              (external_format @':default')
              (search_list ecl_symbol_value_nonnull(the_env, @'si::*load-search-list*'))
...
@
  ...
  filename = ECL_NIL;
  hooks = ecl_symbol_value_nonnull(the_env, @'ext::*load-hooks*');
 ...
 NOT_A_FILENAME:
  ...
  ecl_bds_bind(the_env, @'*package*', ecl_symbol_value_nonnull(the_env, @'*package*'));
  ecl_bds_bind(the_env, @'*readtable*', ecl_symbol_value_nonnull(the_env, @'*readtable*'));
