...
static cl_object
_ecl_weak_pointer_value(cl_object o)
{
...
{
  return (cl_object)GC_call_with_alloc_lock((GC_fn_type)_ecl_weak_pointer_value, o);
}

/* -- finalizers ---------------------------------------------------- */

static void register_finalizer(cl_object o, void *finalized_object,
                               GC_finalization_proc fn, void *cd,
                               GC_finalization_proc *ofn, void **ocd);

static void standard_finalizer(cl_object o);
static void wrapped_finalizer(cl_object o, cl_object finalizer);
static void deferred_finalizer(cl_object* x);
...
ecl_set_finalizer_unprotected(cl_object o, cl_object finalizer)
{
  ...
  /* Return the old finalizer. */
  if (ofn == (GC_finalization_proc)wrapped_finalizer) {
    return (cl_object)odata;
  } else {
    return ECL_NIL;
  }
}
