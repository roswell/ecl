...
ecl_print_base(void)
{
  ...
  cl_object object = ecl_symbol_value_nonnull(the_env, @'*print-base*');
  cl_fixnum base;
...
{
  const cl_env_ptr the_env = ecl_process_env();
  cl_object object = ecl_symbol_value_nonnull(the_env, @'*print-level*');
  cl_fixnum level;
  if (object == ECL_NIL) {
...
{
  const cl_env_ptr the_env = ecl_process_env();
  cl_object object = ecl_symbol_value_nonnull(the_env, @'*print-length*');
  cl_fixnum length;
  if (object == ECL_NIL) {
...
{
  const cl_env_ptr the_env = ecl_process_env();
  cl_object output = ecl_symbol_value_nonnull(the_env, @'*print-case*');
...
@(defun write (x
               ...
               (array ecl_symbol_value_nonnull(the_env, @'*print-array*'))
               (base ecl_symbol_value_nonnull(the_env, @'*print-base*'))
               ((:case cas) ecl_symbol_value_nonnull(the_env, @'*print-case*'))
               (circle ecl_symbol_value_nonnull(the_env, @'*print-circle*'))
               (escape ecl_symbol_value_nonnull(the_env, @'*print-escape*'))
               (gensym ecl_symbol_value_nonnull(the_env, @'*print-gensym*'))
               (length ecl_symbol_value_nonnull(the_env, @'*print-length*'))
               (level ecl_symbol_value_nonnull(the_env, @'*print-level*'))
               (lines ecl_symbol_value_nonnull(the_env, @'*print-lines*'))
               (miser_width ecl_symbol_value_nonnull(the_env, @'*print-miser-width*'))
               (pprint_dispatch ecl_symbol_value_nonnull(the_env, @'*print-pprint-dispatch*'))
               (pretty ecl_symbol_value_nonnull(the_env, @'*print-pretty*'))
               (radix ecl_symbol_value_nonnull(the_env, @'*print-radix*'))
               (readably ecl_symbol_value_nonnull(the_env, @'*print-readably*'))
               (right_margin ecl_symbol_value_nonnull(the_env, @'*print-right-margin*')))
  @
