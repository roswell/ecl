...
{"BYTE", CL_ORDINARY, ECL_NAME(cl_byte), -1, OBJNULL},
...
{"COERCE", CL_ORDINARY, ECL_NAME(cl_coerce), -1, OBJNULL},
...
{"DEPOSIT-FIELD", CL_ORDINARY, ECL_NAME(cl_deposit_field), -1, OBJNULL},
...
{"DPB", CL_ORDINARY, ECL_NAME(cl_dpb), -1, OBJNULL},
...
{"GET-DECODED-TIME", CL_ORDINARY, ECL_NAME(cl_get_decoded_time), -1, OBJNULL},
...
{"LDB", CL_ORDINARY, ECL_NAME(cl_ldb), -1, OBJNULL},
{"LDB-TEST", CL_ORDINARY, ECL_NAME(cl_ldb_test), -1, OBJNULL},
...
{"LOGTEST", CL_ORDINARY, ECL_NAME(cl_logtest), -1, OBJNULL},
...
{"MASK-FIELD", CL_ORDINARY, ECL_NAME(cl_mask_field), -1, OBJNULL},
...
{MP_ "WITH-INTERRUPTS", MP_CONSTANT, NULL, -1, OBJNULL},
