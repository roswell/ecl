...
{EXT_ "STACK-PUSH" ECL_FUN("si_stack_push", si_stack_push, 2) ECL_VAR(EXT_ORDINARY, OBJNULL)},
{EXT_ "STACK-POP" ECL_FUN("si_stack_pop", si_stack_pop, 1) ECL_VAR(EXT_ORDINARY, OBJNULL)},
{EXT_ "STACK-TOP" ECL_FUN("si_stack_top", si_stack_top, 1) ECL_VAR(EXT_ORDINARY, OBJNULL)},
