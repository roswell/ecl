...
{"DRIBBLE", CL_ORDINARY, ECL_NAME(cl_dribble), -2, OBJNULL},
...
{KEY_ "ABORT-SIGNAL-HANDLING", KEYWORD, NULL, -1, OBJNULL},
...
{MP_ "BARRIER-WAIT", MP_ORDINARY, IF_MP(mp_barrier_wait), -2, OBJNULL},
...
{SYS_ "FIND-RELATIVE-PACKAGE", SI_ORDINARY, IF_RELPACK(si_find_relative_package), -2, OBJNULL},
