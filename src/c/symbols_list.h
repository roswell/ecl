...
{SYS_ "MAKE-CACHE" ECL_FUN("si_make_cache", si_make_cache, 2) ECL_VAR(SI_ORDINARY, OBJNULL)},
...
{SYS_ "INSTANCE-SIG-GET" ECL_FUN("si_instance_sig_get", si_instance_sig_get, 1) ECL_VAR(SI_ORDINARY, OBJNULL)},
