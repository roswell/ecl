...
#define ECL_XPACKAGEX_SYMBOL    ((cl_object)(cl_symbols+2))
#define ECL_UNBOUND             ((cl_object)(cl_symbols+3))
#define ECL_PROTECT_TAG         ((cl_object)(cl_symbols+4))
#define ECL_DUMMY_TAG           ((cl_object)(cl_symbols+5))
#define ECL_RESTART_CLUSTERS    ((cl_object)(cl_symbols+6))
#define ECL_HANDLER_CLUSTERS    ((cl_object)(cl_symbols+7))
#define ECL_INTERRUPTS_ENABLED  ((cl_object)(cl_symbols+8))
