...
#define ecl_unbox_int_sse_pack_unsafe(x) (ecl_sse_data(x).vi)
...
#define ecl_unbox_float_sse_pack_unsafe(x) (ecl_sse_data(x).vf)
...
#define ecl_unbox_double_sse_pack_unsafe(x) (ecl_sse_data(x).vd)
