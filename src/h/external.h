...
extern ECL_API cl_object ecl_symbol_value_nonnull(cl_env_ptr the_env, cl_object s);
extern ECL_API cl_object ecl_setq(cl_env_ptr env, cl_object var, cl_object value);
extern ECL_API cl_object ecl_setq_nonnull(cl_env_ptr env, cl_object var, cl_object value);
