...
#ifdef ECL_THREADS
extern ECL_API cl_object mp_compare_and_swap_svref(cl_object x, cl_object index, cl_object old, cl_object new_);
...
#ifdef ECL_THREADS
extern ECL_API cl_object mp_compare_and_swap_symbol_value(cl_object x, cl_object old, cl_object new_);
...
#ifdef ECL_THREADS
extern ECL_API cl_object ecl_compare_and_swap_instance(cl_object x, cl_fixnum i, cl_object old, cl_object new_);
extern ECL_API cl_object mp_compare_and_swap_instance(cl_object x, cl_object index, cl_object old, cl_object new_);
...
#ifdef ECL_THREADS
extern ECL_API cl_object mp_compare_and_swap_car(cl_object x, cl_object old, cl_object new_);
extern ECL_API cl_object mp_atomic_incf_car(cl_object x, cl_object increment);
extern ECL_API cl_object mp_compare_and_swap_cdr(cl_object x, cl_object old, cl_object new_);
...
#ifdef ECL_THREADS
extern ECL_API cl_object mp_compare_and_swap_structure(cl_object x, cl_object type, cl_object index, cl_object old, cl_object new_);
#endif
...
#ifdef ECL_THREADS
extern ECL_API cl_object mp_compare_and_swap_symbol_plist(cl_object x, cl_object old, cl_object new_);
#endif
