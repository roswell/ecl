...
(proclaim '(FTYPE (FUNCTION (T) T) REMOVE-DOCUMENTATION))
(proclaim '(FTYPE (FUNCTION (T T) T) GET-DOCUMENTATION))
(proclaim '(FTYPE (FUNCTION (T T T) T) SET-DOCUMENTATION))
(proclaim '(FTYPE (FUNCTION (T T T) T) EXPAND-SET-DOCUMENTATION))
...
(proclaim '(FTYPE (FUNCTION (T T T) T) PACKAGES-ITERATOR))
...
(proclaim '(FTYPE (FUNCTION (T T T &OPTIONAL T) T) PPRINT-POP-HELPER))
(proclaim '(FTYPE (FUNCTION (T T T T T T) T) PPRINT-LOGICAL-BLOCK-HELPER))
